...
<div id="box1"><img src="<?php echo base_url();?>/asset/images/genres.png" /></div>
...
<form method="post" action="<?php echo base_url();?>index.php/user/adduserinfo">
...
First name: <input type="text" name="c_fname" value="" />
Lastname: <input type="text" name="c_lname" value="" />
Telephone:<input type="text" name="telephone" value="" />
<input type="submit" name="submi" value="ADD" />
